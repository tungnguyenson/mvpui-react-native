...
export const components: ComponentDef[] = [
...

  {
    ...
    category: "Actions",
    description:
      "Accessible, themeable button with 9 color variants and 4 sizes.",
...
>
...

  {
    ...
    category: "Actions",
    description:
      "Floating Action Button — circular or extended pill shape with brand fill and elevation shadow.",
...
<View style={{ position: "absolute", bottom: insets.bottom + 24, right: 24 }}>
...

  {
    ...
    category: "Form",
    description:
      "Text input with label, hint text, error state, and leading/trailing icon support.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Multi-line text input with auto-grow, character count, and the same label/hint/error pattern as Input.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "OTP / PIN code entry with per-digit cells, auto-advance, and paste support.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Accessible form field label with optional required indicator, rendered as Text.",
...
<Label required>Email address</Label>`,
...

  {
    ...
    category: "Form",
    description:
      "Helper or error text rendered below a form field, with variant styling for default and error states.",
...
<HintText variant="error">This field is required.</HintText>`,
...

  {
    ...
    category: "Form",
    description:
      "Tri-state checkbox (checked / unchecked / indeterminate) built on @rn-primitives/checkbox.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Single-selection radio group with accessible keyboard and screen-reader semantics.",
...
<RadioGroup value={plan} onValueChange={setPlan}>
...

  {
    ...
    category: "Form",
    description:
      "Toggle switch for boolean settings, built on @rn-primitives/switch with animated thumb.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Dropdown selector with a sheet-style option list, label, hint, and error state.",
...
>
...

  {
    ...
    category: "Form",
    description:
      "Horizontal range slider for numeric value selection with optional min/max labels.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Numeric increment/decrement control with +/- buttons and an editable value display.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Cross-platform date and/or time picker using @react-native-community/datetimepicker with a custom trigger.",
...
/>`,
...

  {
    ...
    category: "Form",
    description:
      "Layout wrapper that composes Label, a form control, and HintText/error into a vertical stack with consistent spacing.",
...
>
...

  {
    ...
    category: "Form",
    description:
      "List row that composes a title, optional subtitle, and a trailing control (Switch, chevron, badge, or custom) for settings screens.",
...
/>`,
...

  {
    ...
    category: "Overlays",
    description:
      "Modal dialog built on @rn-primitives/dialog with backdrop, animated entry, and compound sub-components.",
...
<Dialog open={open} onOpenChange={setOpen}>
...

  {
    ...
    category: "Overlays",
    description:
      "Gesture-driven bottom sheet built on @gorhom/bottom-sheet with snap points.",
...
<BottomSheet ref={sheetRef} snapPoints={["40%", "75%"]}>
...

  {
    ...
    category: "Overlays",
    description:
      "Context action menu anchored to the bottom of the screen, with labeled action items and a cancel option.",
...
<ActionSheet open={open} onOpenChange={setOpen} title="Photo options">
...

  {
    ...
    category: "Overlays",
    description:
      "Anchor-relative floating panel built on @rn-primitives/popover for tooltips, menus, and pickers.",
...
<Popover>
...

  {
    ...
    category: "Overlays",
    description:
      "Long-press tooltip that shows a short text label anchored to a trigger element.",
...
<Tooltip>
...

  {
    ...
    category: "Overlays",
    description:
      "Long-press context menu with labeled items, built on @rn-primitives/context-menu.",
...
<ContextMenu>
...

  {
    ...
    category: "Overlays",
    description:
      "Temporary notification overlay with 4 severity levels and swipe-to-dismiss.",
...
toast.info("3 items added to cart.")`,
...

  {
    ...
    category: "Overlays",
    description:
      "Full-width informational strip anchored below the header or at the top of a screen for persistent alerts.",
...
/>`,
...

  {
    ...
    category: "Overlays",
    description:
      "Inline status alert box with icon, title, and description for form-level or page-level feedback.",
...
/>`,
...

  {
    ...
    category: "Navigation",
    description:
      "Screen-level navigation header with title, leading back/menu action, and trailing icon buttons.",
...
/>`,
...

  {
    ...
    category: "Navigation",
    description:
      "Bottom tab bar with icon + label tabs, active state, and optional FAB cutout variant.",
...
<TabBar>
...

  {
    ...
    category: "Navigation",
    description:
      "Horizontal tab switcher for in-page content sections, built on @rn-primitives/tabs.",
...
<Tabs value={tab} onValueChange={setTab}>
...

  {
    ...
    category: "Navigation",
    description:
      "Compact multi-option selector styled as a segmented pill — ideal for filter or view-mode toggles.",
...
/>`,
...

  {
    ...
    category: "Navigation",
    description:
      "Search input with leading magnifier icon, clear button, and optional cancel action.",
...
/>`,
...

  {
    ...
    category: "Content",
    description:
      "Surface composition with border and rounded corners — compound sub-components for header, content, and footer.",
...
/>`,
...

  {
    ...
    category: "Content",
    description:
      "Small status label with 12 color variants and optional leading icon, in pill or rounded shape.",
...
<Badge color="success" shape="pill" iconLeading={CheckCircle}>
...

  {
    ...
    category: "Content",
    description:
      "Structured list with dividers, section headers, and customizable row layout.",
...
<List>
...

  {
    ...
    category: "Content",
    description:
      "Expo-image wrapper with blurhash placeholder, content-fit modes, and optional border radius.",
...
/>`,
...

  {
    ...
    category: "Content",
    description:
      "Pulsing placeholder shape for loading states — matches the geometry of the content it replaces.",
...
{isLoading ? (
...

  {
    ...
    category: "Content",
    description:
      "Horizontal linear progress indicator with determinate and indeterminate modes.",
...
<ProgressBar value={uploadProgress} max={100} label="Uploading…" />`,
...

  {
    ...
    category: "Content",
    description:
      "SVG-based circular progress ring with determinate value and optional center label.",
...
/>`,
...

  {
    ...
    category: "Content",
    description:
      "Placeholder UI for empty lists or zero-result states with an icon, heading, description, and CTA.",
...
/>`,
...

  {
    ...
    description:
      "Swipe-to-reveal action row with leading and/or trailing action panels.",
...
>
...

  {
    ...
    category: "Interaction",
    description:
      "Wraps a scroll container with a native pull-to-refresh indicator wired to an async callback.",
...
>
...

  {
    ...
    category: "Interaction",
    description:
      "Scroll container that automatically adjusts its bottom inset when the keyboard appears.",
...
<KeyboardAvoidingScroll contentContainerClassName="gap-5 p-6">
...

  {
    ...
    category: "Interaction",
    description:
      "Utility component and hook for triggering haptic engine feedback via expo-haptics.",
...
triggerHaptic("notificationSuccess")`,
...

  {
    ...
    category: "Utility",
    description:
      "Convenience wrapper that applies safe-area insets as padding on all edges using react-native-safe-area-context.",
...
export default function Screen() {
...

  {
    ...
    category: "Utility",
    description:
      "Configures the system status bar style (light, dark, auto) and background color for a screen.",
...
export default function DarkHeroScreen() {
...

  {
    ...
    category: "Utility",
    description:
      "Thin wrapper around lucide-react-native icons that applies token-derived size and semantic color classes.",
...
<Icon icon={Bell} size={20} color="primary" />`,
...

  {
    ...
    category: "Utility",
    description:
      "Animated loading indicator using react-native-reanimated for smooth rotation.",
