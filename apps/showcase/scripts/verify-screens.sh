...
FLOW="$REPO_ROOT/apps/showcase/.maestro/batch-screens-showcase.yaml"
...
rm -f "$OUT"/[0-9][0-9]-*-light.png "$OUT"/[0-9][0-9]-*-dark.png "$OUT"/[0-9][0-9]-*.png
...
echo ""
echo "==> Captured:"
ls -1 "$OUT"/[0-9][0-9]-*-light.png "$OUT"/[0-9][0-9]-*-dark.png 2>/dev/null || true
